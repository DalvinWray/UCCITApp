            ...
            )
            {
                ...
                for (dc: DocumentChange in value?.documentChanges!!){
                    if (dc.type== DocumentChange.Type.ADDED){
                        ...
                        //Loop was utilized to avoid Array Index Out Of Bounds Exception
                        //Loop will go through the array of the data taken from firebase until it finds one with a matching
                        //position to the one that the user press on
                        //The data will then be sent to the respective text views
                        while(i<courseArrayList.size) {
                            if (i==arrayPosition) {
                                ...
                                courseNameTextView.text =
                                    "Course Name: " + courseArrayList[arrayPosition].CourseName
